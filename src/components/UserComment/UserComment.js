...
function UserComment({firstName, date, content, rating, commentsId, thumbUpUser, thumbDownUser, thumbUpClick, thumbDownClick, token }) {
  ...
  return  (
    ...
    <Comment.Avatar as='a' src="https://cdn-icons-png.flaticon.com/512/4026/4026811.png" className={styles.avatar} />
    <Comment.Content style={{paddingLeft: "10px", width:"100%"}} >
      ...
      <Comment.Text style={{color: "rgb(184, 184, 184)", lineHeight: "150%", padding: "10px 10px 0px 0px"}}>
        ...
        <ThumbUpOffAltOutlinedIcon onClick={thumbUpClickFunc} fontSize="small" style={{cursor:"pointer"}} /> 
        {thumbUpUser > 0 ? <span>{thumbUpUser}</span> : null} |
        <ThumbDownOutlinedIcon onClick={thumbDownClickFunc} fontSize="small" style={{cursor:"pointer"}} />
