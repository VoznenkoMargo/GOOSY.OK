  ...
  return (
    <div className={styles.container}>
      <ArrowBack />
            ...
            return <div className={styles.itemCard} key={item.id}>
                ...
                <div className={styles.orderDetails}>
                    ...
                    <div className={styles.addToCart}>
                        ...
                        <p className={styles.currentPrice}>Price: {item.currentPrice} ₴</p>
        ...
        <h2 className={styles.priceTitle}>Total price:
            <span className={styles.currentPrice}> {cartItems.reduce((sum, price) => sum + price.currentPrice, 0)} ₴</span>
        </h2>
