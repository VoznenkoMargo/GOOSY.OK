...
function FormReg (props) {
    ...
    <div  className = {styles.modal} >
        <div ref={ref} className={styles.modalContent}>
            <Formik initialValues={initialValues} handleKeyDown={handleKeyDown} closeSignUp={closeSignUp} onSubmit={handleSubmit} validationSchema={validationSchema} validateOnBlur>
                ...
                {({ errors, touched, isValid, dirty})=>{
                    ...
                    <Form  className={styles.form}>
                        ...
                        <label htmlFor='birthdate'> Your birthdate
                            <Field className={styles.form_input}  type='date' name='date' placeholder='123' />
                        </label> 
