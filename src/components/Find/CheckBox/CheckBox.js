      ...
      <form>
        <label>
          <input
            ...
            type="checkbox"
            onChange={test}
            value="cold snaks,coldSnaks"
          />
          <p>Cold Snaks</p>
        </label>
        <label>
          <input id="soup" type="checkbox" onChange={test} value="soup" />
          <p>Soup</p>
        </label>
        <label>
          <input id="salads" type="checkbox" onChange={test} value="salads" />
          <p>Salads</p>
        </label>
        <label>
          <input id="desert" type="checkbox" onChange={test} value="desert" />
          <p>Desert</p>
        </label>
        <label>
          <input
