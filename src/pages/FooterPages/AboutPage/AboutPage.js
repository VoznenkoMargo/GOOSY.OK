...
function AboutPage() {
  return <div className={styles.about}>
       <div className={styles.about_back}>
        ...
        <p>067 215 98 88</p>
        <p className={styles.about_padding}>099 888 77 66</p>
        <p className={styles.about_padding}>Do you want to offer cooperation? Are you looking for work or having any ideas for us? Please send a mail to the appropriate department and our specialists will contact you to discuss the details.</p>
        <p>Jobs and vacancies in GOOSY.OK!</p>
        <p className={styles.about_padding}>hr@goosyok.ua</p>
        <p>Suggestions for products, utensils, packaging, etc.</p>
        <p className={styles.about_padding}>tehnolog@goosyok.ua</p>
        <p>Advertising, PR</p>
        <p className={styles.about_padding}>dellead@goosyok.ua</p>
